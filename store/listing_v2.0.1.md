...
> 2026-09-04 기준. Edge 파트너 센터에는 이 문구로 제출 완료(심사 중). Chrome 웹스토어와 Whale 스토어는
> 아래 문구를 그대로 붙여 넣어 갱신합니다.
...
| Chrome 웹 스토어 | 미제출 | 개발자 콘솔이 확장 스크립팅 차단 영역이라 자동화 불가. 직접 업로드 필요 |
| Whale 스토어 | 미제출 | 브라우저 도구의 사이트 접근이 차단되어 미확인. 등록 여부부터 확인 필요 |
