# [soma0sd_NotionExport Meetings & Minutes / 회의 및 회의록 관리]
...
1. **노션(Notion) DB 저장 (Primary)**:
   ...
   - **노션 페이지 제목 양식**: [soma0sd_NotionExport] YYYY-MM-DD 회의록: [주요 의제]`n     - 예: [soma0sd_NotionExport] 2026-07-24 회의록: 주요 안건 논의`n
2. **로컬 Git Repository 저장 (Secondary / Archiving)**:
   - 본 디렉토리(docs/meetings/)에 마크다운 파일로 회의록을 추가 보관합니다.
   - **로컬 파일명 양식**: YYYY-MM-DD_[soma0sd_NotionExport]_[주요의제].md`n     - 예: 2026-07-24_soma0sd_NotionExport_주요안건논의.md`n
3. **공통 가이드라인 & 표준 템플릿**:
...
`markdown
# [soma0sd_NotionExport] YYYY-MM-DD 회의록: [주요 의제/제목]
